...
router.get('/design-sources', authenticateAdmin, dashboardCtrl.getDesignSources);
router.get('/category-performance', authenticateAdmin, dashboardCtrl.getCategoryPerformance);
